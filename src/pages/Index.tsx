      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Dialog open={isWhatsappDialogOpen} onOpenChange={setIsWhatsappDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg px-[25px] py-[35px]">
              <svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor" className="h-8 w-8">
