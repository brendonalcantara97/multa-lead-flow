  ...
  return <div className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Dialog open={isWhatsappDialogOpen} onOpenChange={setIsWhatsappDialogOpen}>
          ...
          <DialogContent className="fixed bottom-20 right-6 w-80 max-w-none p-0 border-0 shadow-2xl rounded-2xl overflow-hidden" style={{
          ...
          backgroundImage: `
            ...
            <div className="bg-[#128C7E] text-white p-3 flex items-center space-x-3">
              <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center overflow-hidden">
                <img src="/lovable-uploads/a07a1208-5b54-4395-9bc1-66dd1b69b39d.png" alt="SOS Multas" className="w-full h-full object-scale-down" />
              </div>
              ...
              <div className="flex justify-end">
                ...
                alignSelf: 'flex-end'
                  ...
                  <form onSubmit={handleWhatsappSubmit} className="space-y-2.5">
                    ...
                    ...prev,
                    name: e.target.value
                  }))} className="w-full h-10 text-sm font-['Open_Sans',sans-serif] text-[#4a4a4a] border border-[#cacaca] rounded-md focus:border-[#cacaca] outline-none" style={{
                    ...
                    violationType: value
                      ...
                      <SelectTrigger className="w-full h-10 text-sm font-['Open_Sans',sans-serif] text-[#4a4a4a] border border-[#cacaca] rounded-md focus:border-[#cacaca] outline-none" style={{
                      backgroundColor: '#e7ffe7',
                      borderLeftStyle: 'none',
                      borderTopStyle: 'none',
                      borderRightStyle: 'solid',
                    ...
                    <Button type="submit" className="w-full max-w-[150px] h-10 text-white font-['Open_Sans',sans-serif] text-base font-normal rounded-md border-none cursor-pointer flex items-center justify-center self-end" style={{
